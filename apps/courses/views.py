...
class VideoView(LoginRequiredMixin, View):
    ...
    def get(self, request, course_id, video_id, *args, **kwargs):
        ...
        content = Video.objects.get(id=int(video_id))
        ...
        all_courses = UserCourse.objects.filter(user_id__in=user_ids).order_by("-course__click_nums")[:4]
...
class CourseListView(View):
    def get(self, request, *args, **kwargs):
        ...
        p = Paginator(all_courses, per_page=9, request=request)#最多单页显示6个课程
        courses = p.page(page)
