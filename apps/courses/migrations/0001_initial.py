# Generated by Django 2.2 on 2020-03-23 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', stdimage.models.StdImageField(upload_to=stdimage.utils.UploadToUUID(path='courses/2020/03'), verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('name', models.CharField(max_length=100, verbose_name='正文名称')),
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长(分钟数)')),
                ('url', models.CharField(blank=True, max_length=1000, null=True, verbose_name='视频地址')),
                ('detail', DjangoUeditor.models.UEditorField(default='', verbose_name='正文详情')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='课程')),
